...
The Gang of Four team bas implemented the famous Space Invadors game for this project. The game includes the traditional components: Aliens, Spaceship, Alien-Bombs. The game objective is for the player to destroy all the aliens before they either destroy the player or invade the player. The team will enhance the traditional game with new features to create a more exhilirating player experience.
<br>
<br>
